    ...
    <header>
        <nav class="navbar">
            ...
            <ul class="navLinks">
                ...
                <li><a href="customerSupport/contactUs.php"><i class="fas fa-envelope"></i> Contact Us</a></li>
            </ul>
            <?php
                if (isset($_SESSION["userData"]) && !empty($_SESSION["userData"]["User_Name"])) {
                    echo '<a class="signin-btn" href="user/accountDetails.php">
                            <i class="fas fa-user"></i> ' . $_SESSION["userData"]["User_Name"] . '
                        </a>';
                } else {
                    echo '<a class="signin-btn" href="user/login.php">
